...
export const localBusinessSchema: LocalBusinessSchema = {
  ...
  url: 'https://htxweb.com',
  telephone: '', // TODO: Update with actual phone
  email: 'james@htxweb.com',
  address: {
  ...
  logo: 'https://htxweb.com/images/logo.png',
  image: ['https://htxweb.com/images/storefront.jpg'],
  priceRange: '$$',
  currenciesAccepted: 'USD',
  paymentAccepted: ['Cash', 'Credit Card', 'Debit Card', 'Check', 'Invoice', 'Bank Transfer'],
  sameAs: [],
  contactPoint: {
    telephone: '', // TODO: Update
    email: 'james@htxweb.com',
...
export const seoConfig: SEOConfig = {
  // Site Identity
  siteName: 'HTX Web Co.',
  siteUrl: 'https://htxweb.com', // Update with actual domain

  // Title Configuration
  titleTemplate: '%s | HTX Web Co.',
  ...
  defaultImageAlt: 'HTX Web Co. - Professional Web Design',
